...
export interface DeleteAnnouncementDialogProps {
  ...
  onCancel?: () => void
  /** Fechar pelo "X", overlay ou Escape. Default: cai no onCancel. */
  onClose?: () => void
}
...
export function DeleteAnnouncementDialog({
  ...
  // Cada linha do título (separada por \n) vira um bloco próprio; sem nowrap,
  // então título customizado/viewport estreita quebra naturalmente em vez de estourar.
  ...
  return (
    ...
    >
      <div
        ...
        // eslint-disable-next-line no-restricted-syntax -- dimensões/paddings fluidos fora da escala: card 289 (mobile) → 462 (desktop) de largura, min-height 417 → 667; padding-x 20px → 60px alinhado ao MESMO intervalo de crescimento do card (722.5px→1155px) para não espremer o conteúdo enquanto a largura está travada no mínimo. Ver AGENTS.md Tokens, exceção pendente de aprovação do TL.
        ...
        style={{
          ...
          minHeight: 'clamp(417px, 58vw, 667px)',
      ...
      >
        ...
        <div className="flex w-full flex-col items-center gap-7 text-center">
          ...
          <div
            ...
            // eslint-disable-next-line no-restricted-syntax -- margin-top fluido fora da escala (8px → 48px); slope (48-8)/432.5 = 0.0925. Ver AGENTS.md Tokens, exceção pendente de aprovação do TL.

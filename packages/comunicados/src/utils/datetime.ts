/**
 * Conversões puras entre instantes ISO-8601 UTC e pares data/hora no fuso de
 * **Brasília** (`America/Sao_Paulo`). Sem React nem DOM — usadas pelo
 * `ScheduleDatePicker` e pelos filtros do mural (`muralFilters`).
 */

 ...
 * Geometria e tokens espelham o átomo `Input` (altura `h-11`, `text-label-md`).
 * O indicador nativo é escondido: o seletor abre **apenas** pelo botão do ícone
 * à esquerda (`showPicker()`), focável por teclado. Estado de erro (barra +
 * mensagem) espelha o átomo `Input`; a borda permanece neutra.
 */

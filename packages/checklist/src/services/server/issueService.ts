...
export async function listIssuesByExecution(executionId: string): Promise<ChecklistIssueResponse[]> {
...
/** OPEN → IN_PROGRESS. */
export async function startIssue(issueId: string): Promise<ChecklistIssueResponse> {
...
export async function resolveIssue(issueId: string): Promise<ChecklistIssueResponse> {
  return http.patch<ChecklistIssueResponse>(
...
export async function validateIssue(issueId: string): Promise<ChecklistIssueResponse> {
  return http.patch<ChecklistIssueResponse>(
...
export async function reopenIssue(issueId: string): Promise<ChecklistIssueResponse> {
  return http.patch<ChecklistIssueResponse>(
...
export async function restartIssueProgress(issueId: string): Promise<ChecklistIssueResponse> {
  return http.patch<ChecklistIssueResponse>(
...
export async function cancelIssue(issueId: string): Promise<ChecklistIssueResponse> {
  return http.patch<ChecklistIssueResponse>(

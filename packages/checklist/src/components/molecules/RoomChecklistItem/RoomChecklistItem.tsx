  ...
  return (
    <div
      className={[
        ...
        .join(' ')}
    >
      <Text variant="label-sm" tone="brand" className="min-w-0 break-words md:text-label-md">
        {room}
      </Text>

      {hasChecklist ? (
        <Button variant="outlined" tone="brand" size="sm" onClick={onView} iconLeft="eye" className="shrink-0">
            Ver Checklist
        </Button>
      ) : (
        <Button

...
export function RoomSelector({ rooms, onSelect, className }: RoomSelectorProps) {
  ...
  return (
    <div
      ...
      className={['flex min-h-screen flex-col items-center justify-center px-4 md:px-8', className]
        .filter(Boolean)
        .join(' ')}
    >
      ...
      <Text variant="heading-h2" tone="brand" className="text-center text-[clamp(24px,4vw,36px)]">

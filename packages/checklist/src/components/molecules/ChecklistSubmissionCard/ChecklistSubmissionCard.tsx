  ...
  return (
    <div
      className={[
        ...
        .join(' ')}
    >
      <Text variant="label-sm" tone="brand" className="md:hidden">
        {room} - {checklistType}
      </Text>

      <Text variant="label-xs" tone="brand" className="hidden md:block md:w-24 md:shrink-0 md:text-label-md">
        {room}
      </Text>

      <Text variant="label-xs" tone="brand" className="md:flex-1 md:text-center md:text-label-md">

...
export const ALERTAS_ORIENTACAO = [
  {
    ...
    description:
      "Turmas do turno manhã com atraso recorrente no envio de ARRIVAL.",
  },
  {
    id: "a2",
    title: "Validar itens de Tecnologia em salas com lab.",
    description:
      "Concentração de falhas em projetor, PC e controles nas últimas 2 semanas.",
  },
  {
    id: "a3",
    title: "Reforçar organização de bancadas pós-intervalo",
    description:
      "POST_BREAK com não conformidades de organização acima da meta.",
  },
];
